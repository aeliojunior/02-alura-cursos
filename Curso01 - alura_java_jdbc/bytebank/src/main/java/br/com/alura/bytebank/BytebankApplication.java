...
public class BytebankApplication {
    ...
    private static int exibirMenu() {
        System.out.println("""
                ...
                7 - Realizar transferência de valor
    ...
    private static void encerrarConta() {
        ...
        service.inativar(numeroDaConta); //encerrar lógico
    ...
    private static void realizarTransferencia() {
        ...
        service.realiarTransferencia(numeroDaContaOrigem, numeroDaContaDestino, valor);
